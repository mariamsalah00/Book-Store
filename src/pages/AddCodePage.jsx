  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-90 text-center">
        {/* Title */}
        <h2 className="text-[1.25rem] font-semibold text-[#D9176C] mb-[0.25em]">
          Reset your password!
        </h2>

        <p className="text-[0.8125rem] text-[#22222280] mb-[2em] leading-relaxed">
          ...
          {({ values, setFieldValue, isSubmitting }) => (
            <Form>
              ...
              <ErrorMessage
                name="code"
                component="div"
                className="text-[0.75rem] text-red-500 mb-[1.2em]"
              />
