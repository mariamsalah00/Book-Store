  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-[1em]">
      <div className="w-full max-w-90 text-center">
        {/* Title */}
        <h2 className="text-[1.25rem] font-semibold text-[#D9176C] mb-[0.4em]">
          Create new password!
        </h2>

        <p className="text-[0.8125rem] text-[#22222280] mb-[0.3em]">
          Create a strong password
        </p>
        <p className="text-[0.75rem] text-[#22222280] mb-[2em]">
            ...
            <Form className="text-left space-y-[1.4em]">
              ...
              <div className="form-control w-full">
                <label className="mb-[0.4em] block">
                  <span className="text-[0.875rem] font-medium text-black">
                    Password
                  </span>
                </label>
                ...
                <p className="text-[0.75rem] text-[#22222280] mt-[0.4em]">
                ...
                <ErrorMessage
                  name="password"
                  component="div"
                  className="text-[0.75rem] text-red-500 mt-[0.3em]"
                />
              </div>
